      ...
      item.addTags([
        new ConsumeTag(item, [
          new Buff(
            10,
            "energy",
            (owner: EntityI, amount: number, buff: Buff) => {
