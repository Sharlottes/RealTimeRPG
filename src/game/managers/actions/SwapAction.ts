...
export class SwapAction extends BaseAction {
	...
	constructor(manager: BattleManager, owner: EntityI, private weapon: WeaponEntity, immediate = false) {
	...
	public description(): string {
		return bundle.format(this.manager.locale, 'action.swap.description', this.owner.inventory.equipments.weapon.item.localName(this.manager.locale), this.weapon.item.localName(this.manager.locale));
	}
